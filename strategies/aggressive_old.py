...
Higher risk, lower allocation (30%)
"""

import json
from pathlib import Path
from services.indicators_old import Indicators
...
class AggressiveStrategy:
    ...
    def __init__(self, logger, price_api):
        ...
        # Load settings
        with open(Path("config") / "settings_aggressive.json", 'r') as f:
